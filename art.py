...
if SERVER_PATHS:
    ...
    DATA_TEST_DIR   ="/home/shared/pizza/data/paint_art_in"
    DATA_OUTPUT_DIR ="/home/shared/pizza/paint_art_out"
    MODEL_DIR       ="/home/shared/pizza/models"
else:
    DATA_TRAIN_DIR  ="C:/Users/Jakub/Desktop/DL_project/pizza_data"
    DATA_TEST_DIR   ="C:/Users/Jakub/Desktop/DL_project/paint_art_in"
    DATA_OUTPUT_DIR ="C:/Users/Jakub/Desktop/DL_project/paint_art_out"
...
with tf.Session() as sess:
    ...
    saver.restore(sess, MODEL_DIR+"/model30.ckpt")
    epoch=30
    i=0
    for batch in batches_test:                
        ...
        img.save(DATA_OUTPUT_DIR+"/e"+str(epoch)+"_"+str(i)+"drop_"+str(DROPOUT)+'.jpg')
        i+=1
        print(i)
