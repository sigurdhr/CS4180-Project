...
if SERVER_PATHS:
    DATA_TRAIN_DIR  ="/home/shared/pizza/data/pizza_canny_train" 
    DATA_TEST_DIR   ="/home/shared/pizza/data/pizza_canny_test"
...
with tf.Session() as sess:
    ...
    for epoch in range(EPOCHS):           
        ...
        if epoch%SAVE_EACH==0: 
            ...
            saver.save(sess,MODEL_DIR+"/model_"+str(epoch)+"_canny"+".ckpt") 
        ...
        if epoch%TEST_EACH==0:
            ...
            for batch in batches_test:                
                ...
                img.save(DATA_OUTPUT_DIR+"/canny_e"+str(epoch)+"_"+str(i)+'.jpg')
                i+=1